...
@MapperScan(value = "com.cotton.impress.mapper")
public class MyDruidDataSource  implements EnvironmentAware {
    ...
    public DruidDataSource dataSource() throws SQLException {
        ...
        //只允许有一个，多个需要改下
        druidDataSource.setConnectionInitSqls(Arrays.asList(propertyResolver.getProperty("connectionInitSqls")));
